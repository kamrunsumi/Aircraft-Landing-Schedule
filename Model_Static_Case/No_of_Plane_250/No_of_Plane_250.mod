...
float g[I] = ...; // The penalty cost (>=0) per unit of time for landing before the target time T[I] for plane i = (1,...P)
float h[I] = ...; // The penalty cost (>=0) per unit of time for landing after the target time T[I] for plane i = (1,...P)
